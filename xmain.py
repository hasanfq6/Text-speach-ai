    ...
    if args.file:
        with open(args.file, 'r') as file:
            ...
            for line_number, line in enumerate(lines, start=1):
                ...
                output_file = f"/sdcard/3tube/lif3/Motive_pri_{str(uuid.uuid4())[:8]}{line_number}.wav"
#                output_file = f"output_{line_number}.wav"
                ...
                os.system(f"python 1sample.py --file {output_file} --image /sdcard/Download/1.png")
